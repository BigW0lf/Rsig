    ...
    toggle.addEventListener('change', () => {
        ...
        apiFetch('/api/prospects')
            ...
            .then(fc => {
                ...
                // Calcul couleur individuelle sur chaque feature
                fc.features.forEach(f => {
                    f.properties._color = evolColor(+f.properties.evol_pct || 0);
                });
                ...
                map.on('click', 'prospects-circle', e => {
                    ...
                    const evolCls = +p.evol_pct >= 20 ? 'tag-up' :
                                    +p.evol_pct >= 10 ? 'tag-up' : '';
